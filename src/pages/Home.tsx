...
import homethumb from '../assets/homethumb.jpg';
import presentation from '../assets/presentation.jpg';
import BSNL from '../assets/rs=h_100,cg_true,m (9).jpg';
import Airtel from '../assets/rs=h_100,cg_true,m (7).jpg';
import Jio from '../assets/rs=h_100,cg_true,m (10).jpg';
import TSSC from '../assets/rs=h_100,cg_true,m (2).jpg';
import NSDC from '../assets/rs=h_100,cg_true,m (3).jpg';
import Utkarsh from '../assets/rs=h_100,cg_true.jpg';
import NCS from '../assets/rs=h_100,cg_true,m.jpg';
import CII from '../assets/rs=h_100,cg_true,m (5).jpg';
import Asschom from '../assets/rs=h_100,cg_true (2).jpg';
import Startup from '../assets/rs=h_100,cg_true (4).jpg';
import ECCouncil from '../assets/rs=h_100,cg_true,m (4).jpg';
import NASSCOM from '../assets/rs=h_100,cg_true (3).jpg';
import WestBengal from '../assets/rs=h_100,cg_true,m (1).jpg';
import ArcGIS from '../assets/rs=h_100,cg_true,m (6).jpg';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
              We are proud to collaborate with these industry leaders.
            </p>
          </div>
            ...
            <div className="flex animate-slide-infinite">
              {[...clientLogos, ...clientLogos].map((logo, index) => (
                <div key={index} className="flex-shrink-0 mx-6" style={{ width: '150px' }}>
                  <img src={logo} alt={`Client logo ${index + 1}`} className="w-full h-auto object-contain" />
                </div>
              ))}
            </div>
          </div>
